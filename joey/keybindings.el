;;; keybindings.el --- joey Layer packages File for Spacemacs
;;
;; Copyright (c) 2015-2016 Joey.Zhang
;;
...
(global-set-key [(shift return)] 'joey/smart-open-line)
(global-set-key (kbd "s-/") 'hippie-expand)
(global-set-key (kbd "C-c a") 'org-agenda)
(define-key global-map (kbd "C-c y") 'youdao-dictionary-search-at-point+)
(define-key global-map (kbd "<f9>") 'org-capture)
(define-key global-map (kbd "C-c t") 'org-capture)
(define-key global-map (kbd "C-c w") 'org-refile)
(define-key global-map (kbd "<f8>") 'joey/show-current-buffer-major-mode)
...
(spacemacs/set-leader-keys "op" 'joey/org-save-and-export)
(spacemacs/set-leader-keys "fR" 'joey/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "or" 'joey/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'joey/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "oll" 'joey/load-my-layout)
(spacemacs/set-leader-keys "ols" 'joey/save-my-layout)
...
(spacemacs/set-leader-keys "os" 'joey/search-in-fireball)
